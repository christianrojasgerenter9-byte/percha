  ...
  return (
    ...
    <div data-om-starter="ios-frame" style={{
      ...
      <div style={{
        ...
        <svg width="26" height="26" viewBox="0 0 26 26" style={{ display: 'block', flex: 'none' }}>
          <rect width="26" height="26" rx="7" fill="#3a76a9" />
          <g fill="none" stroke="#eaf3fb" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
            <path d="M13 7.2a2.1 2.1 0 1 1 2.1 2.1" />
            <path d="M13 9.3v3.1" />
            <path d="M13 12.2 6.4 16.9c-.7.5-.4 1.5.4 1.5h12.4c.8 0 1.1-1 .4-1.5L13 12.2Z" />
          </g>
        </svg>
        <span style={{
